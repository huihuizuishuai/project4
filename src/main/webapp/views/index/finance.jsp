    ...
    <div class="proMain">
    	<div class="hwpzNav">
    		<ul>
    			...
    			<li class="second"><a class="active"  href="<%=basePath%>Main/finance">私募基金</a></li>
    			<li class="three"><a href="<%=basePath%>Main/oversea">海外配置</a></li>
    			<li class="four"><a class="active"  href="<%=basePath%>Main/finance">股权基金</a></li>
    		</ul>
    	</div>
    ...
    <div class="ajaxContainer">
        <!-- 异步内容开始 -->
                <ul class="tbList">
                    ...
                    <li class="five"><a class="abtn" href="/finance/financeView/28">购买</a></li>
                </ul>
                <ul class="tbList">
                    <li class="first">
                        <span class="ico jp"></span>
                    ...
                    <li class="five"><a class="abtn" href="/finance/financeView/27">购买</a></li>
                </ul>
                    <ul class="tbList">
                        <li class="first">
                            <span class="ico jp"></span>
                        ...
                        <li class="five"><a class="abtn" href="/finance/financeView/24">购买</a></li>
                    </ul>
        <!-- 异步内容结束 -->
