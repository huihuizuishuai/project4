...
<body>
	...
	<div class="box-right-main">
		...
		<form action="<%=basePath%>overseaSys/overseaConfig" method="post"
			id="valForm" enctype="multipart/form-data">
				...
				<div class="row bdlist">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="title" class="form-control" placeholder="请输入文本"
									type="text" value=""> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="child_title" class="form-control"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="user_type" class="form-control" placeholder="请输入文本"
									type="text" value=""> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
