...
<script type="text/javascript" src="/winplus/resources/js/bootstrap.js"></script>
</head>
<body>
<img style="position:absolute;width:100%;height:100%;z-Index:-1;position:fixed" src="/winplus/resources/images/login_bg.jpg" />
<table class="tabCenter" width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="middle" align="center"><div id="box_login">
	 <p align="center" style="padding-bottom:25px;"><img src="/winplus/resources/images/yj-logo.png" /></p>     
     <div id="right_login">
       <h1>网站后台管理系统</h1>
       <h2>欢迎登陆！</h2>
...
<script type="text/javascript" src="/winplus/resources/js/adminlogin.js"></script>
